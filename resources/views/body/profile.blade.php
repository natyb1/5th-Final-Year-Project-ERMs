                        ...
                        <div class="card-body pt-3">
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                <li class="nav-item"> <button class="nav-link active" data-bs-toggle="tab"
                                        data-bs-target="#profile-overview">{{ __('Overview') }}</button></li>
                            ...
                            <div class="tab-content pt-2">
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">{{ __('Id') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->emp_id }} </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">{{ __('Full Name') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->name }} {{ $users->mname }}
                                            {{ $users->lname }}</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label "> {{ __('Department') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->department_name }} </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label "> {{ __('Current position') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->job_title }} </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $users->sex }}</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label"> {{ __('Age') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->age }}</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label"> {{ __('Martial Status') }}</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->martial }}</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">{{ __('Martial Status') }}</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $users->worked_for }}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form>
                                        {{-- <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="pt-2"> <a href="#" class="btn btn-primary btn-sm"
                                                        title="Upload new profile image"><i class="bi bi-upload"></i></a> <a
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9"> <input name="address" type="text"
                                                    class="form-control" id="Address" value="Ludhiana, Punjab, India">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Phone</label>
                                            <div class="col-md-8 col-lg-9"> <input name="phone" type="text"
                                                    class="form-control" id="Phone" value="(436) 486-3538 x29071">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
